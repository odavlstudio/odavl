...
exports.NextConfigFileType = void 0;
var promises_1 = require("node:fs/promises");
var node_fs_1 = require("node:fs");
function parseNextConfig(filePath) {
    return __awaiter(this, void 0, void 0, function () {
        var content, lines, features, imports, requires, deps, complexity, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    requires = content.match(/require\s*\(\s*['"]([^'"]+)['"]\s*\)/g) || [];
                    deps = __spreadArray(__spreadArray([], imports.map(function (imp) { var _a; return ((_a = imp.match(/from\s+['"]([^'"]+)['"]/)) === null || _a === void 0 ? void 0 : _a[1]) || ''; }), true), requires.map(function (req) { var _a; return ((_a = req.match(/['"]([^'"]+)['"]/)) === null || _a === void 0 ? void 0 : _a[1]) || ''; }), true).filter(Boolean);
                    complexity = Math.min(100, (features.length * 10) + (lines.length / 5));
                    return [2 /*return*/, {
                            path: filePath,
                            type: 'next-config',
                            size: content.length,
                            ...
                            interfaces: 0,
                            hasTests: false,
                            dependencies: deps.filter(function (d) { return !d.startsWith('.') && !d.startsWith('/'); }),
                        }];
                case 2:
                    error_1 = _a.sent();
                    return [2 /*return*/, {
