...
exports.TypeScriptFileType = void 0;
...
function parseTypeScriptFile(filePath) {
    return __awaiter(this, void 0, void 0, function () {
        var content, lines, imports, importPaths, exports_1, exportNames, functions, classes, interfaces, hasTests, complexity, dependencies, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    exports_1 = content.match(/^export\s+(class|interface|function|const|type|enum)\s+(\w+)/gm) || [];
                    exportNames = exports_1.map(function (exp) {
                        var match = exp.match(/export\s+(?:class|interface|function|const|type|enum)\s+(\w+)/);
                        return match ? match[1] : '';
                    }).filter(Boolean);
                    ...
                    hasTests = filePath.includes('.test.') || filePath.includes('.spec.') || content.includes('describe(') || content.includes('it(');
                    complexity = Math.min(100, (functions * 5) + (classes * 10) + (interfaces * 3) + (lines.length / 10));
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error("Failed to parse TypeScript file ".concat(filePath, ":"), error_1);
                    return [2 /*return*/, {
                            path: filePath,
                            type: 'typescript',
                            size: 0,
