...
import { predictFailureProbabilityEnsemble, buildInputVector } from '../../../../brain/learning/predictors.js';
...
export class RecipeSelector {
   ...
   */
  private async getMLScore(recipeId: string, candidates: AutopilotFixCandidate[]): Promise<number> {
    try {
