...
exports.SmartSecurityScanner = exports.SENSITIVE_PATTERNS = void 0;
...
class SmartSecurityScanner {
        ...
        for (const variable of variables) {
            ...
            if (sensitiveMatch) {
                ...
                const confidenceScore = await (0, confidence_scoring_js_1.calculateAdaptiveConfidence)({
                    patternMatchStrength: confidence_scoring_js_1.PatternStrength.variableName(variable, sensitiveMatch.examples.map(ex => ex.toLowerCase())),
                    contextAppropriate: this.getContextScore(filePath),
                    codeStructure: confidence_scoring_js_1.StructureScore.calculate(line),
                    historicalAccuracy: confidence_scoring_js_1.HistoricalAccuracy.getDefault('security')
                }, signature);
    ...
    isSensitiveVariable(variable) {
        for (const pattern of exports.SENSITIVE_PATTERNS) {
    ...
    getContextScore(filePath) {
        ...
        if (/config\.|\.config\./.test(filePath)) {
            return confidence_scoring_js_1.ContextScore.config(); // 15
        }
...
exports.SmartSecurityScanner = SmartSecurityScanner;
//# sourceMappingURL=smart-security-scanner.js.map