...
exports.PatternMemory = void 0;
exports.getPatternMemory = getPatternMemory;
exports.resetPatternMemory = resetPatternMemory;
const node_fs_1 = require("node:fs");
const node_path_1 = require("node:path");
const node_crypto_1 = require("node:crypto");
const pattern_learning_schema_js_1 = require("./pattern-learning-schema.js");
/**
...
class PatternMemory {
    database;
    config;
    dirty = false; // Track if database needs saving
    constructor(config = {}) {
        this.config = { ...pattern_learning_schema_js_1.DEFAULT_LEARNING_CONFIG, ...config };
    ...
    loadDatabase() {
        ...
        try {
            const content = (0, node_fs_1.readFileSync)(dbPath, 'utf-8');
    ...
    saveDatabase() {
        if (!this.dirty)
            return;
        const dbPath = this.config.databasePath;
        const dbDir = (0, node_path_1.dirname)(dbPath);
        ...
        (0, node_fs_1.writeFileSync)(dbPath, JSON.stringify(this.database, null, 2), 'utf-8');
        this.dirty = false;
    }
    /**
    ...
    recordFailure(signature, confidence, context) {
        ...
        if (pattern.performance.falsePositiveRate > this.config.autoSkipThreshold &&
...
exports.PatternMemory = PatternMemory;
/**
