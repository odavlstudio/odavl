...
function startODAVLProcess(panel, workspaceRoot) {
    if (!workspaceRoot) {
    ...
    const cli = (0, child_process_1.spawn)('tsx', ['apps/cli/src/index.ts', 'run', '--json'], { cwd: workspaceRoot, shell: true });
...
function activate(context) {
    const disposable = vscode.commands.registerCommand('odavl.doctor', () => {
        const panel = vscode.window.createWebviewPanel('odavlDoctor', 'ODAVL Doctor', vscode.ViewColumn.One, {
            enableScripts: true,
