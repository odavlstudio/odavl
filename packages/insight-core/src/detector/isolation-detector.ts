...
export class ComponentIsolationDetector {
    ...
    private readonly THRESHOLDS = {
        ...
        maxLinesOfCode: 300,         // Max LOC for single component
    };
    ...
    private detectGodComponent(filePath: string, metadata: ComponentMetadata): IsolationIssue | null {
        const isGod =
            metadata.linesOfCode > this.THRESHOLDS.maxLinesOfCode ||
            metadata.responsibilities.length > this.THRESHOLDS.maxResponsibilities * 1.5;
