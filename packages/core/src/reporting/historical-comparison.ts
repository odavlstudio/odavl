...
export class HistoricalComparisonEngine {
  ...
  compare(): ComparisonResult {
    ...
    const result: ComparisonResult = {
      metadata: {
        currentTimestamp: new Date(this.config.current.timestamp),
        baselineTimestamp: new Date(this.config.baseline.timestamp),
        timeDelta: new Date(this.config.current.timestamp).getTime() - new Date(this.config.baseline.timestamp).getTime(),
